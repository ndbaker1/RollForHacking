...
function parseCurrentSite(sitePreviewElement) {
    ...
    function parseDOM(elem) {
        ...
        if ( rect.width*rect.height > 250000 ) {
...
function generateLevel() {
    ...
    // The platforms
    let platforms = parseCurrentSite(document.getElementById('external-preview'))
    console.log(platforms)
    // cleanup site preview
    document.getElementById('external-preview').innerHTML = ''
